...
def script_async(params):
    try:
        ...
        client.generate_video(text=params['TEXT'], title=params['TITLE'], red_text=params['PART'], gender=params["GENDER"],output_path="temp"+params["ID"], stock_footage =params["VIDEO"],output_name="video.mp4")
